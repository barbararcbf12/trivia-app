...
function QuestionsList({ query }: QuestionListProps) {
  ...
  return (
    <>
      ...
      <span
        className="text-red-600 pb-6 mb-6">{ formState.isSubmitted ? `${ questions.length - Object.keys(formState.errors).length } / ${ questions.length } correct` : '' }</span>
    </>
  );
}
